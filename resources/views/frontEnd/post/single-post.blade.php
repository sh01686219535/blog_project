                ...
                <div class="col-md-3">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                                <div class="post-entry-1 border-bottom">
                                    ...
                                    <h2 class="mb-2"><a src="#">How to Avoid Distraction and Stay Focused During Video Calls?</a></h2>
                                    <span class="author mb-3 d-block">Jenny Wilson</span>
                                </div>

                                <div class="post-entry-1 border-bottom">
                                    <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2 class="mb-2"><a src="#">17 Pictures of Medium Length Hair in Layers That Will Inspire Your New Haircut</a></h2>
                                    <span class="author mb-3 d-block">Jenny Wilson</span>
                                </div>

                                <div class="post-entry-1 border-bottom">
                                    <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2 class="mb-2"><a src="#">9 Half-up/half-down Hairstyles for Long and Medium Hair</a></h2>
                                    <span class="author mb-3 d-block">Jenny Wilson</span>
                                </div>

                                <div class="post-entry-1 border-bottom">
                                    <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2 class="mb-2"><a src="#">Life Insurance And Pregnancy: A Working Mom’s Guide</a></h2>
                                    <span class="author mb-3 d-block">Jenny Wilson</span>
                                </div>

                                <div class="post-entry-1 border-bottom">
                                    <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2 class="mb-2"><a src="#">The Best Homemade Masks for Face (keep the Pimples Away)</a></h2>
                                    <span class="author mb-3 d-block">Jenny Wilson</span>
                                </div>

                                <div class="post-entry-1 border-bottom">
                                    <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2 class="mb-2"><a src="#">10 Life-Changing Hacks Every Working Mom Should Know</a></h2>
                                    <span class="author mb-3 d-block">Jenny Wilson</span>
                                </div>
                            </div> <!-- End Popular -->
                    ...
                    <div class="aside-block">
                        ...
                        <div class="video-post">
                            <a src="https://www.youtube.com/watch?v=AiFfDjmd0jU" class="glightbox link-video">
                    ...
                    <div class="aside-block">
                        ...
                        <ul class="aside-links list-unstyled">
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Business</a></li>
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Culture</a></li>
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Sport</a></li>
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Food</a></li>
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Politics</a></li>
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Celebrity</a></li>
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Startups</a></li>
                            <li><a src="category.html"><i class="bi bi-chevron-right"></i> Travel</a></li>
                        </ul>
                    </div><!-- End Categories -->
                    ...
                    <div class="aside-block">
                        ...
                        <ul class="aside-tags list-unstyled">
                            <li><a src="category.html">Business</a></li>
                            <li><a src="category.html">Culture</a></li>
                            <li><a src="category.html">Sport</a></li>
                            <li><a src="category.html">Food</a></li>
                            <li><a src="category.html">Politics</a></li>
                            <li><a src="category.html">Celebrity</a></li>
                            <li><a src="category.html">Startups</a></li>
                            <li><a src="category.html">Travel</a></li>
                        </ul>
                    </div><!-- End Tags -->
